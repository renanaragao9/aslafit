    ...
    <div class="container-fluid">
        <div class="card card-outline card-primary">
                        ...
                        <div class="col-12 col-md-6 text-md-right order-1 order-md-2">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb justify-content-md-end">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a href="<?= $this->Url->build(['action' => 'index']) ?>">collaborator</a>
                                    </li>
            ...
            <div class="card-body">
                    ...
                    <div class="col-sm-9 col-md-9 col-lg-9 col-xl-9 control-label">
                        <?= $collaborator->has('user') ? $this->Html->link($collaborator->user->name, ['controller' => 'Users', 'action' => 'view', $collaborator->user->id]) : '' ?>
                    </div>
                </div>
                                     <div class="row item-row">
                    <label class="col-sm-3 col-md-3 col-lg-3 col-xl-3 control-label">
