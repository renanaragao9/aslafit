                ...
                <div class="card card-outline card-primary">
                    ...
                    <div class="card-header d-flex justify-content-between align-items-center flex-wrap">
                        ...
                        <div class="col-12 col-md-6 text-md-right">
                            <?php if (AccessChecker::hasPermission($loggedUserId, 'itemLogs/add')): ?>
                    ...
                    <div class="card-body table-responsive p-0">
                        <table class="table table-hover text-nowrap">
                            ...
                            <tbody id="TableBody">
                                <?php foreach ($itemLogs as $itemLog): ?>
                                <tr>
                                                                                   <td>
                                        <?= $this->Number->format($itemLog->id) ?>
                                    </td>
                                                                               <td>
                                        <?= $itemLog->item ? h($itemLog->item->name) : '-' ?>
                                    </td>
                                                                                     <td>
                                        <?= $itemLog->storage_location ? h($itemLog->storage_location->name) : '-' ?>
                                    </td>
                                                                                       <td>
                                        <?= h($itemLog->available_for_use) ?>
                                    </td>
                                                                                     <td>
                                        <?= h($itemLog->for_sale) ?>
                                    </td>
                                        ...
                                        <?= h($itemLog->modified) ?>
                                                                           ...
                                                                           <td class="actions">
                                        <a href="#" class="btn btn-view btn-sm" data-toggle="modal" data-target="#detailsModal-<?= $itemLog->id ?>">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <?php if (AccessChecker::hasPermission($loggedUserId, 'itemLogs/edit')): ?>
                                            <a href="#" class="btn btn-edit btn-sm" data-toggle="modal" data-target="#editModal-<?= $itemLog->id ?>">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                        <?php endif; ?>
                                        <?php if (AccessChecker::hasPermission($loggedUserId, 'itemLogs/delete')): ?>
                                            <a href="#" class="btn btn-delete btn-sm" data-toggle="modal" data-target="#deleteModal-<?= $itemLog->id ?>">
                                ...
                                <!-- Modal de Delete -->
                                <div class="modal fade" id="deleteModal-<?= $itemLog->id ?>" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel-<?= $itemLog->id ?>" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="deleteModalLabel-<?= $itemLog->id ?>">
                                            ...
                                            <div class="modal-body">
                                                <p>
                                                    <?= __('Você tem certeza que deseja excluir {0}?', $itemLog->name) ?>
                                                </p>
                                            </div>
                                            <div class="modal-footer justify-content-between">
                                                ...
                                                <?= $this->Form->postLink(__('Excluir'),
                                                    [
                                                        'action' => 'delete', $itemLog->id
                                                    ], 
                                                    [
                                                        'class' => 'btn modalDelete', 
                                                        'id' => 'deleteButton-' . $itemLog->id, 
                                                        'data-id' => $itemLog->id
                                                    ])
                                                ?>
                                            </div>
                                ...
                                <!-- Modal de Detalhes -->
                                <div class="modal fade" id="detailsModal-<?= $itemLog->id ?>" tabindex="-1" role="dialog" aria-labelledby="detailsModalLabel-<?= $itemLog->id ?>" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="detailsModalLabel-<?= $itemLog->id ?>">
                                                    Visualizar
                                                    <?= h($itemLog->name) ?>
                                                </h5>
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12 col-md-6">
                                                            <ul class="list-group list-group-flush">
                                                                    ...
                                                                    <li class="list-group-item">
                                                                        <strong>Id:</strong>
                                                                        <span> <?= h($itemLog->id) ?> </span>
                                                                    </li>
                                                                       
                                                                    <li class="list-group-item">
                                                                        <strong>Item Id:</strong>
                                                                        <span> <?= h($itemLog->item_id) ?> </span>
                                                                    </li>
                                                                       
                                                                    <li class="list-group-item">
                                                                        <strong>Location Id:</strong>
                                                                        <span> <?= h($itemLog->location_id) ?> </span>
                                                                    </li>
                                                                       
                                                                    <li class="list-group-item">
                                                                        <strong>Available For Use:</strong>
                                                                        <span> <?= h($itemLog->available_for_use) ?> </span>
                                                                    </li>
                                                                                                                                           </ul>
                                                            <hr />
                                                        </div>
                                                        <div class="col-12 col-md-6">
                                                            <ul class="list-group list-group-flush">
                                                                        ...
                                                                        <span><?= h($itemLog->for_sale) ?> </span>
                                                                    </li>
                                                                     
                                                                                                                                     <li class="list-group-item">
                                                                        <strong>Active:</strong>
                                                                        <span><?= h($itemLog->active) ?> </span>
                                                                    </li>
                                                                     
                                                                                                                                     <li class="list-group-item">
                                                                        <strong>Sold:</strong>
                                                                        <span><?= h($itemLog->sold) ?> </span>
                                                                    </li>
                                                                     
                                                                                                                                     <li class="list-group-item">
                                                                        <strong>Created:</strong>
                                                                        <span><?= h($itemLog->created) ?> </span>
                                                                    </li>
                                                                     
                                                                                                                                     <li class="list-group-item">
                                                                        <strong>Modified:</strong>
                                                                        <span><?= h($itemLog->modified) ?> </span>
                                                                    </li>
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a href="<?= $this->Url->build(['action' => 'view', $itemLog->id]) ?>" class="btn modalView">
                                                    Ver Detalhes
                                                </a>
                                            </div>
                                        </div>
