                ...
                <div class="card card-outline card-primary">
                    ...
                    <div class="card-header d-flex justify-content-between align-items-center flex-wrap">
                        ...
                        <div class="col-12 col-md-6 text-md-right">
                            <?php if (AccessChecker::hasPermission($loggedUserId, 'students/add')): ?>
                        ...
                        <table class="table table-hover text-nowrap">
                            ...
                            <tbody id="TableBody">
                                ...
                                <tr>
                                        ...
                                        <?php endif; ?>
                                        <?php if (AccessChecker::hasPermission($loggedUserId, 'students/delete')): ?>
                                            <a href="#" class="btn btn-delete btn-sm" data-toggle="modal" data-target="#deleteModal-<?= $student->id ?>">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-12 col-md-6">
                                                            <ul class="list-group list-group-flush">
                                                                        ...
                                                                        <span><?= h($student->height) ?> </span>
                                                                    </li>
                                                                     
                                                                                                                                     <li class="list-group-item">
                                                                        <strong>Color:</strong>
                                                                        <span><?= h($student->color) ?> </span>
                                                                    </li>
                                                                     
                                                                                                                                     <li class="list-group-item">
                                                                        <strong>Img:</strong>
                                                                        <span><?= h($student->img) ?> </span>
                                                                    </li>
                                                                     
                                                                                                                                     <li class="list-group-item">
                                                                        <strong>Active:</strong>
                                                                        <span><?= h($student->active) ?> </span>
                                                                    </li>
                                                                     
                                                                                                                                     <li class="list-group-item">
                                                                        <strong>User Id:</strong>
                                                                        <span><?= h($student->user_id) ?> </span>
                                                                    </li>
