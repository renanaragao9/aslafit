                ...
                <div class="card card-outline card-primary">
                    ...
                    <div class="card-header d-flex justify-content-between align-items-center flex-wrap">
                        ...
                        <div class="col-12 col-md-6 text-md-right">
                            <?php if (AccessChecker::hasPermission($loggedUserId, 'contacts/add')): ?>
                    ...
                    <div class="card-body table-responsive p-0">
                        <table class="table table-hover text-nowrap">
                            <thead>
                                <tr>
                                        ...
                                        <?= $this->Paginator->sort('id') ?>
                                                                        ...
                                                                        <th>
                                        <?= $this->Paginator->sort('contactable_type') ?>
                                    </th>
                                                                        <th>
                                        <?= $this->Paginator->sort('contactable_id') ?>
                                    </th>
                                                                        <th>
                                        <?= $this->Paginator->sort('contact_type') ?>
                                    </th>
                                                                        <th>
                                        <?= $this->Paginator->sort('contact_value') ?>
                                    </th>
                                                                        <th>
                            ...
                            <tbody id="TableBody">
                                ...
                                <tr>
                                                                             <td>
                                        <?= $this->Number->format($contact->id) ?>
                                    </td>
                                                                               <td>
                                        <?= h($contact->contactable_type) ?>
                                    </td>
                                                                               <td>
                                        <?= $this->Number->format($contact->contactable_id) ?>
                                    </td>
                                                                               <td>
                                        <?= h($contact->contact_type) ?>
                                    </td>
                                                                               <td>
                                        <?= h($contact->contact_value) ?>
                                    </td>
                                                                               <td>
                                        <?= h($contact->active) ?>
                                    </td>
                                        ...
                                        <?= h($contact->modified) ?>
                                                                           ...
                                                                           <td class="actions">
                                        <a href="#" class="btn btn-view btn-sm" data-toggle="modal" data-target="#detailsModal-<?= $contact->id ?>">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <?php if (AccessChecker::hasPermission($loggedUserId, 'contacts/edit')): ?>
                                            <a href="#" class="btn btn-edit btn-sm" data-toggle="modal" data-target="#editModal-<?= $contact->id ?>">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                        <?php endif; ?>
                                        <?php if (AccessChecker::hasPermission($loggedUserId, 'contacts/delete')): ?>
                                            <a href="#" class="btn btn-delete btn-sm" data-toggle="modal" data-target="#deleteModal-<?= $contact->id ?>">
                                    ...
                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <p>
                                                    <?= __('Você tem certeza que deseja excluir {0}?', $contact->name) ?>
                                                </p>
                                            </div>
                                ...
                                <!-- Modal de Detalhes -->
                                <div class="modal fade" id="detailsModal-<?= $contact->id ?>" tabindex="-1" role="dialog" aria-labelledby="detailsModalLabel-<?= $contact->id ?>" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="detailsModalLabel-<?= $contact->id ?>">
                                                    Visualizar
                                                    <?= h($contact->name) ?>
                                                </h5>
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12 col-md-6">
                                                            <ul class="list-group list-group-flush">
                                                                    ...
                                                                    <li class="list-group-item">
                                                                        <strong>Id:</strong>
                                                                        <span> <?= h($contact->id) ?> </span>
                                                                    </li>
                                                                       
                                                                    <li class="list-group-item">
                                                                        <strong>Contactable Type:</strong>
                                                                        <span> <?= h($contact->contactable_type) ?> </span>
                                                                    </li>
                                                                       
                                                                    <li class="list-group-item">
                                                                        <strong>Contactable Id:</strong>
                                                                        <span> <?= h($contact->contactable_id) ?> </span>
                                                                    </li>
                                                                       
                                                                    <li class="list-group-item">
                                                                        <strong>Contact Type:</strong>
                                                                        <span> <?= h($contact->contact_type) ?> </span>
                                                                    </li>
                                                                                                                                         </ul>
                                                            <hr />
                                                        </div>
                                                        <div class="col-12 col-md-6">
                                                            <ul class="list-group list-group-flush">
                                                                        ...
                                                                        <span><?= h($contact->contact_value) ?> </span>
                                                                    </li>
                                                                     
                                                                                                                                     <li class="list-group-item">
                                                                        <strong>Active:</strong>
                                                                        <span><?= h($contact->active) ?> </span>
                                                                    </li>
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a href="<?= $this->Url->build(['action' => 'view', $contact->id]) ?>" class="btn modalView">
                                                    Ver Detalhes
                                                </a>
                                            </div>
                                        </div>
