...
$this->assign('title', 'Visualizar local de armazenamento');
?>
        ...
        <div class="card card-outline card-primary">
                ...
                <div class="container-fluid">
                    <div class="row align-items-center">
                        <div class="col-12 col-md-6 order-2 order-md-1 mt-4">
                            <h3 class="card-title">
                                <?= __('Visualizar local de armazenamento') ?>
                            </h3>
                        </div>
                        <div class="col-12 col-md-6 text-md-right order-1 order-md-2">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb justify-content-md-end">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a href="<?= $this->Url->build(['action' => 'index']) ?>">Locais de armazenamentos</a>
                                    </li>
            ...
            <div class="card-body">
                ...
                <div class="row item-row">
                    ...
                    <div class="col-sm-9 col-md-9 col-lg-9 col-xl-9 control-label">
                        <?= !empty($storageLocation->description) ? h($storageLocation->description) : '-' ?>
                    </div>
                </div>
                <div class="row item-row">
                    <label class="col-sm-3 col-md-3 col-lg-3 col-xl-3 control-label">
