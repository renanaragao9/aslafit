                ...
                <div class="card card-outline card-primary">
                    ...
                    <div class="card-header d-flex justify-content-between align-items-center flex-wrap">
                        ...
                        <div class="col-12 col-md-6 text-md-right">
                            <?php if (AccessChecker::hasPermission($loggedUserId, 'statisticsLogs/add')): ?>
                    ...
                    <div class="card-body table-responsive p-0">
                        <table class="table table-hover text-nowrap">
                            <thead>
                                <tr>
                                        ...
                                        <?= $this->Paginator->sort('id') ?>
                                                                        ...
                                                                        <th>
                                        <?= $this->Paginator->sort('statistic_type') ?>
                                    </th>
                                                                        <th>
                            ...
                            <tbody id="TableBody">
                                <?php foreach ($statisticsLogs as $statisticsLog): ?>
                                <tr>
                                                                             <td>
                                        <?= $this->Number->format($statisticsLog->id) ?>
                                    </td>
                                                                               <td>
                                        <?= h($statisticsLog->statistic_type) ?>
                                    </td>
                                                                               <td>
                                        <?= $this->Number->format($statisticsLog->reference_id) ?>
                                    </td>
                                                                               <td>
                                        <?= $this->Number->format($statisticsLog->value) ?>
                                    </td>
                                                                               <td>
                                        <?= h($statisticsLog->date) ?>
                                    </td>
                                                                               <td>
                                        <?= h($statisticsLog->created) ?>
                                    </td>
                                                                               <td>
                                        <?= h($statisticsLog->modified) ?>
                                    </td>
                                                                           <td class="actions">
                                        <a href="#" class="btn btn-view btn-sm" data-toggle="modal" data-target="#detailsModal-<?= $statisticsLog->id ?>">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <?php if (AccessChecker::hasPermission($loggedUserId, 'statisticsLogs/edit')): ?>
                                            <a href="#" class="btn btn-edit btn-sm" data-toggle="modal" data-target="#editModal-<?= $statisticsLog->id ?>">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                        <?php endif; ?>
                                        <?php if (AccessChecker::hasPermission($loggedUserId, 'statisticsLogs/delete')): ?>
                                            <a href="#" class="btn btn-delete btn-sm" data-toggle="modal" data-target="#deleteModal-<?= $statisticsLog->id ?>">
                                ...
                                <!-- Modal de Delete -->
                                <div class="modal fade" id="deleteModal-<?= $statisticsLog->id ?>" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel-<?= $statisticsLog->id ?>" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="deleteModalLabel-<?= $statisticsLog->id ?>">
                                            ...
                                            <div class="modal-body">
                                                <p>
                                                    <?= __('Você tem certeza que deseja excluir {0}?', $statisticsLog->name) ?>
                                                </p>
                                            </div>
                                            <div class="modal-footer justify-content-between">
                                                ...
                                                <?= $this->Form->postLink(__('Excluir'),
                                                    [
                                                        'action' => 'delete', $statisticsLog->id
                                                    ], 
                                                    [
                                                        'class' => 'btn modalDelete', 
                                                        'id' => 'deleteButton-' . $statisticsLog->id, 
                                                        'data-id' => $statisticsLog->id
                                                    ])
                                                ?>
                                            </div>
                                        </div>
                                ...
                                <!-- Modal de Detalhes -->
                                <div class="modal fade" id="detailsModal-<?= $statisticsLog->id ?>" tabindex="-1" role="dialog" aria-labelledby="detailsModalLabel-<?= $statisticsLog->id ?>" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="detailsModalLabel-<?= $statisticsLog->id ?>">
                                                    Visualizar
                                                    <?= h($statisticsLog->name) ?>
                                                </h5>
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                    <span aria-hidden="true">&times;</span>
                                                </button>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12 col-md-6">
                                                            <ul class="list-group list-group-flush">
                                                                    ...
                                                                    <li class="list-group-item">
                                                                        <strong>Id:</strong>
                                                                        <span> <?= h($statisticsLog->id) ?> </span>
                                                                    </li>
                                                                       
                                                                    <li class="list-group-item">
                                                                        <strong>Statistic Type:</strong>
                                                                        <span> <?= h($statisticsLog->statistic_type) ?> </span>
                                                                    </li>
                                                                       
                                                                    <li class="list-group-item">
                                                                        <strong>Reference Id:</strong>
                                                                        <span> <?= h($statisticsLog->reference_id) ?> </span>
                                                                    </li>
                                                                                                                                         </ul>
                                                            <hr />
                                                        </div>
                                                        <div class="col-12 col-md-6">
                                                            <ul class="list-group list-group-flush">
                                                                                                                                     ...
                                                                                                                                     <li class="list-group-item">
                                                                        <strong>Value:</strong>
                                                                        <span><?= h($statisticsLog->value) ?> </span>
                                                                    </li>
                                                                     
                                                                                                                                     <li class="list-group-item">
                                                                        <strong>Date:</strong>
                                                                        <span><?= h($statisticsLog->date) ?> </span>
                                                                    </li>
                                                                     
                                                                                                                                     <li class="list-group-item">
                                                                        <strong>Created:</strong>
                                                                        <span><?= h($statisticsLog->created) ?> </span>
                                                                    </li>
                                                                     
                                                                                                                                     <li class="list-group-item">
                                                                        <strong>Modified:</strong>
                                                                        <span><?= h($statisticsLog->modified) ?> </span>
                                                                    </li>
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a href="<?= $this->Url->build(['action' => 'view', $statisticsLog->id]) ?>" class="btn modalView">
                                                    Ver Detalhes
                                                </a>
                                            </div>
                                        </div>
