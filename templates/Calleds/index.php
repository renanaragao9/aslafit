                ...
                <div class="card card-outline card-primary">
                    ...
                    <div class="card-header d-flex justify-content-between align-items-center flex-wrap">
                        ...
                        <div class="col-12 col-md-6 text-md-right">
                            <?php if (AccessChecker::hasPermission($loggedUserId, 'calleds/add')): ?>
                            ...
                            <tbody id="TableBody">
                                ...
                                <tr>
                                        ...
                                        <?= h($called->active) ?>
                                                                               ...
                                                                               <td>
                                        <?= $called->collaborator ? h($called->collaborator->name) : '-' ?>
                                    </td>
                                                                                     <td>
                                        <?= $called->student ? h($called->student->name) : '-' ?>
                                    </td>
                                                                                       <td>
                                        <?= h($called->created) ?>
                                    </td>
                                        ...
                                        <?= h($called->modified) ?>
                                                                           ...
                                                                           <td class="actions">
                                        <a href="#" class="btn btn-view btn-sm" data-toggle="modal" data-target="#detailsModal-<?= $called->id ?>">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <?php if (AccessChecker::hasPermission($loggedUserId, 'calleds/edit')): ?>
                                            <a href="#" class="btn btn-edit btn-sm" data-toggle="modal" data-target="#editModal-<?= $called->id ?>">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                        <?php endif; ?>
                                        <?php if (AccessChecker::hasPermission($loggedUserId, 'calleds/delete')): ?>
                                            <a href="#" class="btn btn-delete btn-sm" data-toggle="modal" data-target="#deleteModal-<?= $called->id ?>">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-12 col-md-6">
                                                            <ul class="list-group list-group-flush">
                                                                        ...
                                                                        <span><?= h($called->active) ?> </span>
                                                                    </li>
                                                                     
                                                                                                                                     <li class="list-group-item">
                                                                        <strong>Collaborator Id:</strong>
                                                                        <span><?= h($called->collaborator_id) ?> </span>
                                                                    </li>
                                                                     
                                                                                                                                     <li class="list-group-item">
                                                                        <strong>Student Id:</strong>
                                                                        <span><?= h($called->student_id) ?> </span>
                                                                    </li>
