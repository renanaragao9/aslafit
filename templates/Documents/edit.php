    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editModalLabel-<?= $document->id ?>">
                    <?= __('Editar') ?>
                </h5>
            ...
            <div class="modal-body">
                <?= $this->Form->create($document, ['url' => ['action' => 'edit', $document->id], 'id' => 'editForm-' . $document->id]) ?>
                    <div class="row">
                                                                                    <div class="col-lg-6 col-s12">
                                        <div class="form-group">
                                            <?= $this->Form->control('documentable_type', 
                                                [
                                                    'class' => 'form-control'
                                                ]) 
                                            ?>
                                        ...
                                        <div class="form-group">
                                            <?= $this->Form->control('documentable_id', 
                                                [
                                                    'class' => 'form-control'
                                                ]) 
                                            ?>
