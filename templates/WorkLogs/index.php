                ...
                <div class="card card-outline card-primary">
                    ...
                    <div class="card-header d-flex justify-content-between align-items-center flex-wrap">
                        ...
                        <div class="col-12 col-md-6 text-md-right">
                            <?php if (AccessChecker::hasPermission($loggedUserId, 'workLogs/add')): ?>
                    ...
                    <div class="card-body table-responsive p-0">
                        <table class="table table-hover text-nowrap">
                            <thead>
                                <tr>
                                        ...
                                        <?= $this->Paginator->sort('collaborator_id') ?>
                                                                        ...
                                                                        <th>
                                        <?= $this->Paginator->sort('log_date') ?>
                                    </th>
                                                                        <th>
                                        <?= $this->Paginator->sort('log_type') ?>
                                    </th>
                                                                        <th>
                                        <?= $this->Paginator->sort('log_time') ?>
                                    </th>
                                                                        <th>
                                        <?= $this->Paginator->sort('log_address') ?>
                                    </th>
                                                                        <th>
                            ...
                            <tbody id="TableBody">
                                ...
                                <tr>
                                                                                 <td>
                                        <?= $this->Number->format($workLog->id) ?>
                                    </td>
                                                                               <td>
                                        <?= $workLog->collaborator ? h($workLog->collaborator->name) : '-' ?>
                                    </td>
                                                                                     <td>
                                        <?= h($workLog->log_date) ?>
                                    </td>
                                        ...
                                        <?= h($workLog->log_time) ?>
                                                                                   ...
                                                                                   <td>
                                        <?= h($workLog->log_address) ?>
                                    </td>
                                                                                   <td>
                                        <?= $workLog->latitude === null ? '' : $this->Number->format($workLog->latitude) ?>
                                    </td>
                                                                                   <td>
                                        <?= $workLog->longitude === null ? '' : $this->Number->format($workLog->longitude) ?>
                                    </td>
                                                                                   <td>
                                        <?= h($workLog->created) ?>
                                    </td>
                                        ...
                                        <?= h($workLog->modified) ?>
                                                                           ...
                                                                           <td class="actions">
                                        <a href="#" class="btn btn-view btn-sm" data-toggle="modal" data-target="#detailsModal-<?= $workLog->id ?>">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <?php if (AccessChecker::hasPermission($loggedUserId, 'workLogs/edit')): ?>
                                            <a href="#" class="btn btn-edit btn-sm" data-toggle="modal" data-target="#editModal-<?= $workLog->id ?>">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                        <?php endif; ?>
                                        <?php if (AccessChecker::hasPermission($loggedUserId, 'workLogs/delete')): ?>
                                            <a href="#" class="btn btn-delete btn-sm" data-toggle="modal" data-target="#deleteModal-<?= $workLog->id ?>">
