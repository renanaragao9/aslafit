...
$this->assign('title', 'Registros de trabalho');
?>
                        ...
                        <div class="container-fluid">
                            <div class="row align-items-center">
                                <div class="col-12 col-md-6 order-2 order-md-1 mt-4">
                                    <h3 class="card-title">
                                        <?= __('Gerenciar registros de trabalho') ?>
                                    </h3>
                                </div>
                        ...
                        <table class="table table-hover text-nowrap">
                            <thead>
                                <tr>
                                    ...
                                    <th>
                                        <?= $this->Paginator->sort('log_date', 'Data do Registro') ?>
                                    </th>
                                    <th>
                                        <?= $this->Paginator->sort('log_type', 'Tipo de Registro') ?>
                                    </th>
                                    <th>
                                        <?= $this->Paginator->sort('log_time', 'Hora do Registro') ?>
                                    </th>
                                    <th class="actions">
                                        <?= __('Ações') ?>
                                    </th>
...
$this->Html->script('WorkLogs/geographical.js', ['block' => true]);
?>