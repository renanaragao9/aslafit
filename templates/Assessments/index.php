                        ...
                        <table class="table table-hover text-nowrap">
                            <thead>
                                <tr>
                                    ...
                                    <th>
                                        <?= $this->Paginator->sort('goal', 'Objetivo') ?>
                                    </th>
                                    <th>
                                        <?= $this->Paginator->sort('term', 'Prazo') ?>
                                    </th>
                                    <th>
                                        <?= $this->Paginator->sort('height', 'Altura') ?>
                                    </th>
                                    <th>
                            ...
                            <tbody id="TableBody">
                                <?php foreach ($assessments as $assessment): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?= $assessment->ficha ? h($assessment->ficha->student->name) : '-' ?>
                                        </td>
                                        <td>
                                            <?= h($assessment->goal) ?>
                                        </td>
