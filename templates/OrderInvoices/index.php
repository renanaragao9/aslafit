                ...
                <div class="card card-outline card-primary">
                    ...
                    <div class="card-header d-flex justify-content-between align-items-center flex-wrap">
                        ...
                        <div class="col-12 col-md-6 text-md-right">
                            <?php if (AccessChecker::hasPermission($loggedUserId, 'orderInvoices/add')): ?>
                    ...
                    <div class="card-body table-responsive p-0">
                        <table class="table table-hover text-nowrap">
                            ...
                            <tbody id="TableBody">
                                <?php foreach ($orderInvoices as $orderInvoice): ?>
                                <tr>
                                                                                 <td>
                                        <?= $this->Number->format($orderInvoice->id) ?>
                                    </td>
                                                                               <td>
                                        <?= $orderInvoice->order ? h($orderInvoice->order->order_number) : '-' ?>
                                    </td>
                                                                                     <td>
                                        <?= h($orderInvoice->status) ?>
                                    </td>
                                                                                   <td>
                                        <?= h($orderInvoice->paid) ?>
                                    </td>
                                                                                   <td>
                                        <?= h($orderInvoice->created) ?>
                                    </td>
                                                                                   <td>
                                        <?= h($orderInvoice->modified) ?>
                                    </td>
                                                                           <td class="actions">
                                        <a href="#" class="btn btn-view btn-sm" data-toggle="modal" data-target="#detailsModal-<?= $orderInvoice->id ?>">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <?php if (AccessChecker::hasPermission($loggedUserId, 'orderInvoices/edit')): ?>
                                            <a href="#" class="btn btn-edit btn-sm" data-toggle="modal" data-target="#editModal-<?= $orderInvoice->id ?>">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                        <?php endif; ?>
                                        <?php if (AccessChecker::hasPermission($loggedUserId, 'orderInvoices/delete')): ?>
                                            <a href="#" class="btn btn-delete btn-sm" data-toggle="modal" data-target="#deleteModal-<?= $orderInvoice->id ?>">
                                ...
                                <!-- Modal de Delete -->
                                <div class="modal fade" id="deleteModal-<?= $orderInvoice->id ?>" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel-<?= $orderInvoice->id ?>" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="deleteModalLabel-<?= $orderInvoice->id ?>">
                                            ...
                                            <div class="modal-body">
                                                <p>
                                                    <?= __('Você tem certeza que deseja excluir {0}?', $orderInvoice->name) ?>
                                                </p>
                                            </div>
                                            <div class="modal-footer justify-content-between">
                                                ...
                                                <?= $this->Form->postLink(__('Excluir'),
                                                    [
                                                        'action' => 'delete', $orderInvoice->id
                                                    ], 
                                                    [
                                                        'class' => 'btn modalDelete', 
                                                        'id' => 'deleteButton-' . $orderInvoice->id, 
                                                        'data-id' => $orderInvoice->id
                                                    ])
                                                ?>
                                            </div>
                                        </div>
                                ...
                                <!-- Modal de Detalhes -->
                                <div class="modal fade" id="detailsModal-<?= $orderInvoice->id ?>" tabindex="-1" role="dialog" aria-labelledby="detailsModalLabel-<?= $orderInvoice->id ?>" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="detailsModalLabel-<?= $orderInvoice->id ?>">
                                                    Visualizar
                                                    <?= h($orderInvoice->name) ?>
                                                </h5>
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12 col-md-6">
                                                            <ul class="list-group list-group-flush">
                                                                    ...
                                                                    <li class="list-group-item">
                                                                        <strong>Id:</strong>
                                                                        <span> <?= h($orderInvoice->id) ?> </span>
                                                                    </li>
                                                                       
                                                                    <li class="list-group-item">
                                                                        <strong>Order Id:</strong>
                                                                        <span> <?= h($orderInvoice->order_id) ?> </span>
                                                                    </li>
                                                                       
                                                                    <li class="list-group-item">
                                                                        <strong>Status:</strong>
                                                                        <span> <?= h($orderInvoice->status) ?> </span>
                                                                    </li>
                                                                                                                                       </ul>
                                                            <hr />
                                                        </div>
                                                        <div class="col-12 col-md-6">
                                                            <ul class="list-group list-group-flush">
                                                                                                                                     ...
                                                                                                                                     <li class="list-group-item">
                                                                        <strong>Paid:</strong>
                                                                        <span><?= h($orderInvoice->paid) ?> </span>
                                                                    </li>
                                                                     
                                                                                                                                     <li class="list-group-item">
                                                                        <strong>Created:</strong>
                                                                        <span><?= h($orderInvoice->created) ?> </span>
                                                                    </li>
                                                                     
                                                                                                                                     <li class="list-group-item">
                                                                        <strong>Modified:</strong>
                                                                        <span><?= h($orderInvoice->modified) ?> </span>
                                                                    </li>
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a href="<?= $this->Url->build(['action' => 'view', $orderInvoice->id]) ?>" class="btn modalView">
                                                    Ver Detalhes
                                                </a>
                                            </div>
                                        </div>
