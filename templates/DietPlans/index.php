...
$this->assign('title', 'Planos Alimentares');
?>
                        ...
                        <div class="container-fluid">
                            <div class="row align-items-center">
                                <div class="col-12 col-md-6 order-2 order-md-1 mt-4">
                                    <h3 class="card-title">
                                        <?= __('Gerenciar planos alimentares') ?>
                                    </h3>
                                </div>
                        ...
                        <table class="table table-hover text-nowrap">
                            <thead>
                                <tr>
                                    ...
                                    <th>
                                        <?= $this->Paginator->sort('meal_type_id', 'Tipo de Refeição') ?>
                                    </th>
                                    <th>
                            ...
                            <tbody id="TableBody">
                                <?php foreach ($dietPlans as $dietPlan): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?= $dietPlan->ficha ? h($dietPlan->ficha->student->name) : '-' ?>
                                        </td>
                                        <td>
