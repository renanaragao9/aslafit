                ...
                <div class="card card-outline card-primary">
                    ...
                    <div class="card-header d-flex justify-content-between align-items-center flex-wrap">
                        ...
                        <div class="col-12 col-md-6 text-md-right">
                            <?php if (AccessChecker::hasPermission($loggedUserId, 'itemsFields/add')): ?>
                    ...
                    <div class="card-body table-responsive p-0">
                        <table class="table table-hover text-nowrap">
                            <thead>
                                <tr>
                                        ...
                                        <?= $this->Paginator->sort('item_type_id') ?>
                                                                        ...
                                                                        <th>
                                        <?= $this->Paginator->sort('field_name') ?>
                                    </th>
                                                                        <th>
                                        <?= $this->Paginator->sort('field_type') ?>
                                    </th>
                                                                        <th>
                            ...
                            <tbody id="TableBody">
                                <?php foreach ($itemsFields as $itemsField): ?>
                                <tr>
                                                                                 <td>
                                        <?= $this->Number->format($itemsField->id) ?>
                                    </td>
                                                                               <td>
                                        <?= $itemsField->item_type ? h($itemsField->item_type->name) : '-' ?>
                                    </td>
                                                                                     <td>
                                        <?= h($itemsField->field_name) ?>
                                    </td>
                                                                                   <td>
                                        <?= h($itemsField->field_type) ?>
                                    </td>
                                                                                   <td>
                                        <?= h($itemsField->created) ?>
                                    </td>
                                                                                   <td>
                                        <?= h($itemsField->modified) ?>
                                    </td>
                                                                           <td class="actions">
                                        <a href="#" class="btn btn-view btn-sm" data-toggle="modal" data-target="#detailsModal-<?= $itemsField->id ?>">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <?php if (AccessChecker::hasPermission($loggedUserId, 'itemsFields/edit')): ?>
                                            <a href="#" class="btn btn-edit btn-sm" data-toggle="modal" data-target="#editModal-<?= $itemsField->id ?>">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                        <?php endif; ?>
                                        <?php if (AccessChecker::hasPermission($loggedUserId, 'itemsFields/delete')): ?>
                                            <a href="#" class="btn btn-delete btn-sm" data-toggle="modal" data-target="#deleteModal-<?= $itemsField->id ?>">
                                ...
                                <!-- Modal de Delete -->
                                <div class="modal fade" id="deleteModal-<?= $itemsField->id ?>" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel-<?= $itemsField->id ?>" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="deleteModalLabel-<?= $itemsField->id ?>">
                                            ...
                                            <div class="modal-body">
                                                <p>
                                                    <?= __('Você tem certeza que deseja excluir {0}?', $itemsField->name) ?>
                                                </p>
                                            </div>
                                            <div class="modal-footer justify-content-between">
                                                ...
                                                <?= $this->Form->postLink(__('Excluir'),
                                                    [
                                                        'action' => 'delete', $itemsField->id
                                                    ], 
                                                    [
                                                        'class' => 'btn modalDelete', 
                                                        'id' => 'deleteButton-' . $itemsField->id, 
                                                        'data-id' => $itemsField->id
                                                    ])
                                                ?>
                                            </div>
                                        </div>
                                ...
                                <!-- Modal de Detalhes -->
                                <div class="modal fade" id="detailsModal-<?= $itemsField->id ?>" tabindex="-1" role="dialog" aria-labelledby="detailsModalLabel-<?= $itemsField->id ?>" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="detailsModalLabel-<?= $itemsField->id ?>">
                                                    Visualizar
                                                    <?= h($itemsField->name) ?>
                                                </h5>
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12 col-md-6">
                                                            <ul class="list-group list-group-flush">
                                                                    ...
                                                                    <li class="list-group-item">
                                                                        <strong>Id:</strong>
                                                                        <span> <?= h($itemsField->id) ?> </span>
                                                                    </li>
                                                                       
                                                                    <li class="list-group-item">
                                                                        <strong>Item Type Id:</strong>
                                                                        <span> <?= h($itemsField->item_type_id) ?> </span>
                                                                    </li>
                                                                       
                                                                    <li class="list-group-item">
                                                                        <strong>Field Name:</strong>
                                                                        <span> <?= h($itemsField->field_name) ?> </span>
                                                                    </li>
                                                                                                                                       </ul>
                                                            <hr />
                                                        </div>
                                                        <div class="col-12 col-md-6">
                                                            <ul class="list-group list-group-flush">
                                                                        ...
                                                                        <span><?= h($itemsField->field_type) ?> </span>
                                                                    </li>
                                                                     
                                                                                                                                     <li class="list-group-item">
                                                                        <strong>Created:</strong>
                                                                        <span><?= h($itemsField->created) ?> </span>
                                                                    </li>
                                                                     
                                                                                                                                     <li class="list-group-item">
                                                                        <strong>Modified:</strong>
                                                                        <span><?= h($itemsField->modified) ?> </span>
                                                                    </li>
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a href="<?= $this->Url->build(['action' => 'view', $itemsField->id]) ?>" class="btn modalView">
                                                    Ver Detalhes
                                                </a>
                                            </div>
                                        </div>
