                ...
                <div class="card card-outline card-primary">
                    ...
                    <div class="card-header d-flex justify-content-between align-items-center flex-wrap">
                        ...
                        <div class="col-12 col-md-6 text-md-right">
                            <?php if (AccessChecker::hasPermission($loggedUserId, 'addresses/add')): ?>
                            ...
                            <thead>
                                <tr>
                                        ...
                                        <?= $this->Paginator->sort('id') ?>
                                                                        ...
                                                                        <th>
                                        <?= $this->Paginator->sort('addressable_type') ?>
                                    </th>
                                                                        <th>
                                        <?= $this->Paginator->sort('addressable_id') ?>
                                    </th>
                                                                        <th>
                                        <?= $this->Paginator->sort('zipcode') ?>
                                    </th>
                                                                        <th>
                                        ...
                                        <?= $this->Paginator->sort('number') ?>
                                                                        ...
                                                                        <th>
                                        <?= $this->Paginator->sort('complement') ?>
                                    </th>
                                                                        <th>
                                        <?= $this->Paginator->sort('neighborhood') ?>
                                    </th>
                                                                        <th>
                                        ...
                                        <?= $this->Paginator->sort('state') ?>
                                                                        ...
                                                                        <th>
                                        <?= $this->Paginator->sort('latitude') ?>
                                    </th>
                                                                        <th>
                                        <?= $this->Paginator->sort('longitude') ?>
                                    </th>
                                                                        <th>
                            ...
                            <tbody id="TableBody">
                                ...
                                <tr>
                                        ...
                                        <?= $this->Number->format($address->id) ?>
                                                                               ...
                                                                               <td>
                                        <?= h($address->addressable_type) ?>
                                    </td>
                                                                               <td>
                                        <?= $this->Number->format($address->addressable_id) ?>
                                    </td>
                                                                               <td>
                                        <?= h($address->zipcode) ?>
                                    </td>
                                        ...
                                        <?= h($address->state) ?>
                                                                               ...
                                                                               <td>
                                        <?= $address->latitude === null ? '' : $this->Number->format($address->latitude) ?>
                                    </td>
                                                                               <td>
                                        <?= $address->longitude === null ? '' : $this->Number->format($address->longitude) ?>
                                    </td>
                                                                               <td>
                                        <?= h($address->active) ?>
                                    </td>
                                        ...
                                        <?= h($address->modified) ?>
                                                                           ...
                                                                           <td class="actions">
                                        <a href="#" class="btn btn-view btn-sm" data-toggle="modal" data-target="#detailsModal-<?= $address->id ?>">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <?php if (AccessChecker::hasPermission($loggedUserId, 'addresses/edit')): ?>
                                            <a href="#" class="btn btn-edit btn-sm" data-toggle="modal" data-target="#editModal-<?= $address->id ?>">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                        <?php endif; ?>
                                        <?php if (AccessChecker::hasPermission($loggedUserId, 'addresses/delete')): ?>
                                            <a href="#" class="btn btn-delete btn-sm" data-toggle="modal" data-target="#deleteModal-<?= $address->id ?>">
                                    ...
                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="deleteModalLabel-<?= $address->id ?>">
                                            ...
                                            <div class="modal-body">
                                                <p>
                                                    <?= __('Você tem certeza que deseja excluir {0}?', $address->name) ?>
                                                </p>
                                            </div>
                                ...
                                <!-- Modal de Detalhes -->
                                <div class="modal fade" id="detailsModal-<?= $address->id ?>" tabindex="-1" role="dialog" aria-labelledby="detailsModalLabel-<?= $address->id ?>" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="detailsModalLabel-<?= $address->id ?>">
                                                    Visualizar
                                                    <?= h($address->name) ?>
                                                </h5>
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12 col-md-6">
                                                            <ul class="list-group list-group-flush">
                                                                    ...
                                                                    <li class="list-group-item">
                                                                        <strong>Id:</strong>
                                                                        <span> <?= h($address->id) ?> </span>
                                                                    </li>
                                                                       
                                                                    <li class="list-group-item">
                                                                        <strong>Addressable Type:</strong>
                                                                        <span> <?= h($address->addressable_type) ?> </span>
                                                                    </li>
                                                                       
                                                                    <li class="list-group-item">
                                                                        <strong>Addressable Id:</strong>
                                                                        <span> <?= h($address->addressable_id) ?> </span>
                                                                    </li>
                                                                       
                                                                    <li class="list-group-item">
                                                                        <strong>Zipcode:</strong>
                                                                        <span> <?= h($address->zipcode) ?> </span>
                                                                    </li>
                                                                       
                                                                    <li class="list-group-item">
                                                                        <strong>Address:</strong>
                                                                        <span> <?= h($address->address) ?> </span>
                                                                    </li>
                                                                       
                                                                    <li class="list-group-item">
                                                                        <strong>Number:</strong>
                                                                        <span> <?= h($address->number) ?> </span>
                                                                    </li>
                                                                       
                                                                    <li class="list-group-item">
                                                                        <strong>Complement:</strong>
                                                                        <span> <?= h($address->complement) ?> </span>
                                                                    </li>
                                                                                                                                                 </ul>
                                                            <hr />
                                                        </div>
                                                        <div class="col-12 col-md-6">
                                                            <ul class="list-group list-group-flush">
                                                                        ...
                                                                        <span><?= h($address->neighborhood) ?> </span>
                                                                    </li>
                                                                        ...
                                                                        <span><?= h($address->latitude) ?> </span>
                                                                    </li>
                                                                     
                                                                                                                                     <li class="list-group-item">
                                                                        <strong>Longitude:</strong>
                                                                        <span><?= h($address->longitude) ?> </span>
                                                                    </li>
                                                                     
                                                                                                                                     <li class="list-group-item">
                                                                        <strong>Active:</strong>
                                                                        <span><?= h($address->active) ?> </span>
                                                                    </li>
                                                                     
                                                                                                                                     <li class="list-group-item">
                                                                        <strong>Created:</strong>
                                                                        <span><?= h($address->created) ?> </span>
                                                                    </li>
                                                                     
                                                                                                                                     <li class="list-group-item">
                                                                        <strong>Modified:</strong>
                                                                        <span><?= h($address->modified) ?> </span>
                                                                    </li>
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a href="<?= $this->Url->build(['action' => 'view', $address->id]) ?>" class="btn modalView">
                                                    Ver Detalhes
                                                </a>
                                            </div>
                                        </div>
