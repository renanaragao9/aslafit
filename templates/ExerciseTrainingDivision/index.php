                ...
                <div class="card card-outline card-primary">
                        ...
                        <div class="container-fluid">
                            <div class="row align-items-center">
                                <div class="col-12 col-md-6 order-2 order-md-1 mt-4">
                                    <h3 class="card-title">
                                        <?= __('Gerenciar exerciseTrainingDivision') ?>
                                    </h3>
                                </div>
                    ...
                    <div class="card-header d-flex justify-content-between align-items-center flex-wrap">
                        ...
                        <div class="col-12 col-md-6 text-md-right">
                            <?php if (AccessChecker::hasPermission($loggedUserId, 'exerciseTrainingDivision/add')): ?>
                    ...
                    <div class="card-body table-responsive p-0">
                        <table class="table table-hover text-nowrap">
                            <thead>
                                <tr>
                                        ...
                                        <?= $this->Paginator->sort('order') ?>
                                                                        ...
                                                                        <th>
                                        <?= $this->Paginator->sort('series') ?>
                                    </th>
                                                                        <th>
                                        <?= $this->Paginator->sort('repetitions') ?>
                                    </th>
                                                                        <th>
                                        <?= $this->Paginator->sort('weight') ?>
                                    </th>
                                                                        <th>
                                        <?= $this->Paginator->sort('rest') ?>
                                    </th>
                                                                        <th>
                                        ...
                                        <?= $this->Paginator->sort('ficha_id') ?>
                                                                        ...
                                                                        <th>
                                        <?= $this->Paginator->sort('exercise_id') ?>
                                    </th>
                                                                        <th>
                                        <?= $this->Paginator->sort('training_division_id') ?>
                                    </th>
                                                                        <th>
                            ...
                            <tbody id="TableBody">
                                <?php foreach ($exerciseTrainingDivision as $exerciseTrainingDivision): ?>
                                <tr>
                                                                                     <td>
                                        ...
                                        <?= h($exerciseTrainingDivision->description) ?>
                                                                               ...
                                                                               <td>
                                        <?= $exerciseTrainingDivision->ficha ? h($exerciseTrainingDivision->ficha->id) : '-' ?>
                                    </td>
                                                                                       <td>
                                        <?= $exerciseTrainingDivision->exercise ? h($exerciseTrainingDivision->exercise->name) : '-' ?>
                                    </td>
                                                                                       <td>
                                        <?= $exerciseTrainingDivision->training_division ? h($exerciseTrainingDivision->training_division->name) : '-' ?>
                                    </td>
                                                                                         <td>
                                        ...
                                        <?= h($exerciseTrainingDivision->modified) ?>
                                                                           ...
                                                                           <td class="actions">
                                        <a href="#" class="btn btn-view btn-sm" data-toggle="modal" data-target="#detailsModal-<?= $exerciseTrainingDivision->id ?>">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <?php if (AccessChecker::hasPermission($loggedUserId, 'exerciseTrainingDivision/edit')): ?>
                                            <a href="#" class="btn btn-edit btn-sm" data-toggle="modal" data-target="#editModal-<?= $exerciseTrainingDivision->id ?>">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                        <?php endif; ?>
                                        <?php if (AccessChecker::hasPermission($loggedUserId, 'exerciseTrainingDivision/delete')): ?>
                                            <a href="#" class="btn btn-delete btn-sm" data-toggle="modal" data-target="#deleteModal-<?= $exerciseTrainingDivision->id ?>">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer justify-content-between">
                                                ...
                                                <?= $this->Form->postLink(__('Excluir'),
                                                    [
                                                        'action' => 'delete', $exerciseTrainingDivision->id
                                                    ], 
                                                    [
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12 col-md-6">
                                                            <ul class="list-group list-group-flush">
                                                                    ...
                                                                    <li class="list-group-item">
                                                                        <strong>Order:</strong>
                                                                        <span> <?= h($exerciseTrainingDivision->order) ?> </span>
                                                                    </li>
                                                        ...
                                                        <div class="col-12 col-md-6">
                                                            <ul class="list-group list-group-flush">
                                                                        ...
                                                                        <span><?= h($exerciseTrainingDivision->ficha_id) ?> </span>
                                                                    </li>
                                                                     
                                                                                                                                     <li class="list-group-item">
                                                                        <strong>Exercise Id:</strong>
                                                                        <span><?= h($exerciseTrainingDivision->exercise_id) ?> </span>
                                                                    </li>
                                                                     
                                                                                                                                     <li class="list-group-item">
                                                                        <strong>Training Division Id:</strong>
                                                                        <span><?= h($exerciseTrainingDivision->training_division_id) ?> </span>
                                                                    </li>
                                                                     
                                                                                                                                     <li class="list-group-item">
                                                                        <strong>Active:</strong>
                                                                        <span><?= h($exerciseTrainingDivision->active) ?> </span>
                                                                    </li>
        ...
        <div class="modal-content modal-content-filter">
            <div class="modal-header">
                <h5 class="modal-title" id="filterModalLabel">
                    Filtrar Exercise Training Division
                </h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
