...
$this->assign('title', 'Fichas de treino');
?>
                        ...
                        <table class="table table-hover text-nowrap">
                            <thead>
                                <tr>
                                    ...
                                    <th>
                                        <?= $this->Paginator->sort('ficha_id', 'Ficha') ?>
                                    </th>
                                    <th>
                                        <?= $this->Paginator->sort('training_division_id', 'Divisão de Treino') ?>
                                    </th>
                                    <th>
                                        <?= $this->Paginator->sort('exercise_id', 'Exercício') ?>
                                    </th>
                                    <th>
                            ...
                            <tbody id="TableBody">
                                <?php foreach ($exerciseTrainingDivision as $exerciseTrainingDivision): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?= $exerciseTrainingDivision->ficha ? h($exerciseTrainingDivision->ficha->student->name) : '-' ?>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <?php if ($exerciseTrainingDivision->active): ?>
