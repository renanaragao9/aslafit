...
$this->assign('title', 'Tipos de plano');
?>
                        ...
                        <table class="table table-hover text-nowrap">
                            <thead>
                                <tr>
                                    ...
                                    <th>
                                        <?= $this->Paginator->sort('months', 'Meses') ?>
                                    </th>
                                    <th>
                            ...
                            <tbody id="TableBody">
                                <?php foreach ($planTypes as $planType): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?= $this->Number->format($planType->months) ?> <?= $planType->months == 1 ? 'mês' : 'meses' ?>
                                        </td>
                                        <td>
                                            R$ <?= number_format($planType->value, 2, ',', '.') ?>
                                        </td>
                                        <td>
                                            <?php if ($planType->active): ?>
