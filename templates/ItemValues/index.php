                ...
                <div class="card card-outline card-primary">
                    ...
                    <div class="card-header d-flex justify-content-between align-items-center flex-wrap">
                        ...
                        <div class="col-12 col-md-6 text-md-right">
                            <?php if (AccessChecker::hasPermission($loggedUserId, 'itemValues/add')): ?>
                            ...
                            <tbody id="TableBody">
                                ...
                                <tr>
                                        ...
                                        <?= $this->Number->format($itemValue->id) ?>
                                                                               ...
                                                                               <td>
                                        <?= $itemValue->item ? h($itemValue->item->name) : '-' ?>
                                    </td>
                                                                                     <td>
                                        <?= $itemValue->items_field ? h($itemValue->items_field->field_name) : '-' ?>
                                    </td>
                                                                                       <td>
                                        <?= h($itemValue->value) ?>
                                    </td>
                                        ...
                                        <?= h($itemValue->modified) ?>
                                                                           ...
                                                                           <td class="actions">
                                        <a href="#" class="btn btn-view btn-sm" data-toggle="modal" data-target="#detailsModal-<?= $itemValue->id ?>">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <?php if (AccessChecker::hasPermission($loggedUserId, 'itemValues/edit')): ?>
                                            <a href="#" class="btn btn-edit btn-sm" data-toggle="modal" data-target="#editModal-<?= $itemValue->id ?>">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                        <?php endif; ?>
                                        <?php if (AccessChecker::hasPermission($loggedUserId, 'itemValues/delete')): ?>
                                            <a href="#" class="btn btn-delete btn-sm" data-toggle="modal" data-target="#deleteModal-<?= $itemValue->id ?>">
                                ...
                                <!-- Modal de Delete -->
                                <div class="modal fade" id="deleteModal-<?= $itemValue->id ?>" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel-<?= $itemValue->id ?>" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="deleteModalLabel-<?= $itemValue->id ?>">
                                            ...
                                            <div class="modal-body">
                                                <p>
                                                    <?= __('Você tem certeza que deseja excluir {0}?', $itemValue->name) ?>
                                                </p>
                                            </div>
                                            <div class="modal-footer justify-content-between">
                                                ...
                                                <?= $this->Form->postLink(__('Excluir'),
                                                    [
                                                        'action' => 'delete', $itemValue->id
                                                    ], 
                                                    [
                                                        'class' => 'btn modalDelete', 
                                                        'id' => 'deleteButton-' . $itemValue->id, 
                                ...
                                <!-- Modal de Detalhes -->
                                <div class="modal fade" id="detailsModal-<?= $itemValue->id ?>" tabindex="-1" role="dialog" aria-labelledby="detailsModalLabel-<?= $itemValue->id ?>" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="detailsModalLabel-<?= $itemValue->id ?>">
                                                    Visualizar
                                                    <?= h($itemValue->name) ?>
                                                </h5>
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12 col-md-6">
                                                            <ul class="list-group list-group-flush">
                                                                    ...
                                                                    <li class="list-group-item">
                                                                        <strong>Id:</strong>
                                                                        <span> <?= h($itemValue->id) ?> </span>
                                                                    </li>
                                                                       
                                                                    <li class="list-group-item">
                                                                        <strong>Item Id:</strong>
                                                                        <span> <?= h($itemValue->item_id) ?> </span>
                                                                    </li>
                                                                       
                                                                    <li class="list-group-item">
                                                                        <strong>Field Id:</strong>
                                                                        <span> <?= h($itemValue->field_id) ?> </span>
                                                                    </li>
                                                                                                                                       </ul>
                                                            <hr />
                                                        </div>
                                                        <div class="col-12 col-md-6">
                                                            <ul class="list-group list-group-flush">
                                                                                                                                     ...
                                                                                                                                     <li class="list-group-item">
                                                                        <strong>Value:</strong>
                                                                        <span><?= h($itemValue->value) ?> </span>
                                                                    </li>
                                                                     
                                                                                                                                     <li class="list-group-item">
                                                                        <strong>Created:</strong>
                                                                        <span><?= h($itemValue->created) ?> </span>
                                                                    </li>
                                                                     
                                                                                                                                     <li class="list-group-item">
                                                                        <strong>Modified:</strong>
                                                                        <span><?= h($itemValue->modified) ?> </span>
                                                                    </li>
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a href="<?= $this->Url->build(['action' => 'view', $itemValue->id]) ?>" class="btn modalView">
                                                    Ver Detalhes
                                                </a>
                                            </div>
                                        </div>
