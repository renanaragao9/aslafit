...
class DocumentsTable extends Table
{
    ...
    public function initialize(array $config): void
    {
        ...
        $this->setDisplayField('documentable_type');
    ...
    {
        $validator
            ->scalar('documentable_type')
            ->maxLength('documentable_type', 255)
            ->requirePresence('documentable_type', 'create')
            ->notEmptyString('documentable_type');

        $validator
            ->requirePresence('documentable_id', 'create')
            ->notEmptyString('documentable_id');
